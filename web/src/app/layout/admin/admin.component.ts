...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  constructor(public menuItems: MenuItems,
    ...
    if(token ==null){
      this.itemsMenuItems =[];
      this.version = ""
      this.translate.get('admin.user')
      .subscribe((value)=>{
        this.nameUser = value
      })
    }else {
      this.translate.get('admin.version')
      .subscribe((value)=>{
        this.version = value
      })
      debugger
      ...
      this.nameUser = name;
      this.nameUser = this.nameUser['name'];
      this.itemsMenuItems = menuItems.getAll()
    }
